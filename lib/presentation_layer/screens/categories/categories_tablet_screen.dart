...
import 'package:martizoom/presentation_layer/widgets/category/category_tablet_widget.dart';
...
class CategoriesTabletScreen extends StatefulWidget {
  final String marketId;
  final String marketName;

  CategoriesTabletScreen(
      {Key? key, required this.marketId, required this.marketName})
      : super(key: key);

  @override
  State<CategoriesTabletScreen> createState() => _CategoriesTabletScreenState();
}

class _CategoriesTabletScreenState extends State<CategoriesTabletScreen> {
                              ...
                              fallback: (context) {
                                return GridView.builder(
                                  ...
                                  gridDelegate:
                                    ...
                                    childAspectRatio:
                                        _isLandscape ? 1.4 / 2 : 1.6 / 2,
                                  ),
                                  itemBuilder:
                                      (BuildContext context, int index) {
                                    return CategoryTabletWidget(
