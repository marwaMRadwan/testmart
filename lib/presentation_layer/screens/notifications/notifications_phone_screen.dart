...
import '../single_order/single_order_phone_screen.dart';

class NotificationsPhoneScreen extends StatefulWidget {
  const NotificationsPhoneScreen({Key? key}) : super(key: key);

  @override
  State<NotificationsPhoneScreen> createState() =>
      _NotificationsPhoneScreenState();
}

class _NotificationsPhoneScreenState extends State<NotificationsPhoneScreen> {
              ...
              fallback: (context) {
                return BuildCondition(
                    ...
                    builder: (_) => DefaultEmptyItemsText(
                        itemsName: appLocalization!.notifications),
                    fallback: (context) {
                      return BuildCondition(
                          condition:
