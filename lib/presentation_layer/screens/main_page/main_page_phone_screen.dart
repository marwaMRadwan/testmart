...
import 'package:martizoom/presentation_layer/screens/login/login_phone_screen.dart';
...
class MainPagePhoneScreen extends StatefulWidget {
  final bool showViewDialog;

  MainPagePhoneScreen({Key? key, required this.showViewDialog})
      : super(key: key);

  @override
  State<MainPagePhoneScreen> createState() => _MainPagePhoneScreenState();
}

class _MainPagePhoneScreenState extends State<MainPagePhoneScreen> {
  ...
  Widget build(BuildContext context) {
    final MainPagePhoneCubit _mainPageCubit = MainPagePhoneCubit.get(context);
    return BlocConsumer<UserDataCubit, UserDataState>(
      listener: (context, state) {
        // TODO: implement listener
      },
      builder: (context, state) {
        return BlocConsumer<MainPagePhoneCubit, MainPagePhoneState>(
          listener: (context, state) {
            // TODO: implement listener
          },
          builder: (context, state) {
