...
class UpdatePasswordTabletScreen extends StatelessWidget {
  UpdatePasswordTabletScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: DefaultTabletAppBar(title: appLocalization!.updatePassword,),
