...
class ComparingPhoneScreen extends StatefulWidget {
  final double shippingPrice;
  final String? couponCode;

  ComparingPhoneScreen({
    Key? key,
  ...
  @override
  State<ComparingPhoneScreen> createState() => _ComparingPhoneScreenState();
}

class _ComparingPhoneScreenState extends State<ComparingPhoneScreen> {
