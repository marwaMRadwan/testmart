...
class SingleOrderTabletScreen extends StatefulWidget {
  final String orderId;
  final bool restartApp;

  SingleOrderTabletScreen({
    Key? key,
  ...
  @override
  State<SingleOrderTabletScreen> createState() =>
      _SingleOrderTabletScreenState();
}

class _SingleOrderTabletScreenState extends State<SingleOrderTabletScreen> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: MultiBlocProvider(
          providers: [
            BlocProvider(
              create: (context) => _singleOrderCubit,
            ),
          ],
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  ListView.separated(
                                    ...
                                    itemCount:
                                        _singleOrderCubit.products.length,
                                    separatorBuilder:
