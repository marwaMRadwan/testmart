...
import 'package:martizoom/presentation_layer/screens/app_item_info/app_item_info_phone_screen.dart';
...
class AboutAppPhoneScreen extends StatefulWidget {
  const AboutAppPhoneScreen({Key? key}) : super(key: key);

  @override
  State<AboutAppPhoneScreen> createState() => _AboutAppPhoneScreenState();
}

class _AboutAppPhoneScreenState extends State<AboutAppPhoneScreen> {
