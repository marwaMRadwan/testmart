...
import 'package:martizoom/presentation_layer/screens/products/products_tablet_screen.dart';
...
class StandsTabletView extends StatefulWidget {
  String marketId;
  String categoryId;
  String categoryName;
  ...
  @override
  State<StandsTabletView> createState() => _StandsTabletViewState();
}

class _StandsTabletViewState extends State<StandsTabletView> {
