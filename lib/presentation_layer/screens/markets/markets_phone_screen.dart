...
class MarketsPhoneScreen extends StatefulWidget {
  MarketsPhoneScreen({Key? key}) : super(key: key);

  @override
  State<MarketsPhoneScreen> createState() => _MarketsPhoneScreenState();
}

class _MarketsPhoneScreenState extends State<MarketsPhoneScreen> {
