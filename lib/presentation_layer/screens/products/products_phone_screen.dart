...
import 'package:martizoom/presentation_layer/widgets/product/product_phone_widget.dart';
...
class ProductsPhoneScreen extends StatefulWidget {
  final String standId;
  final String marketId;
  final String categoryId;

  const ProductsPhoneScreen({
    Key? key,
  ...
  @override
  State<ProductsPhoneScreen> createState() => _ProductsPhoneScreenState();
}

class _ProductsPhoneScreenState extends State<ProductsPhoneScreen> {
