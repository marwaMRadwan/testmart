...
import 'package:martizoom/presentation_layer/screens/comparing/comparing_tablet_screen.dart';
...
class CartsTabletScreen extends StatefulWidget {
  ...
  @override
  State<CartsTabletScreen> createState() => _CartsTabletScreenState();
}

class _CartsTabletScreenState extends State<CartsTabletScreen> {
  final CouponCubit _couponCubit = CouponCubit();

  final TextEditingController _couponTextController = TextEditingController();

  late final MyCartsCubit _myCartsCubit;
