...
class ProductTabletWidget extends StatefulWidget {
  final ProductModel productModel;
  final String marketId;

  const ProductTabletWidget(
      {Key? key, required this.productModel, required this.marketId})
      : super(key: key);

  @override
  State<ProductTabletWidget> createState() => _ProductTabletWidgetState();
}

class _ProductTabletWidgetState extends State<ProductTabletWidget> {
