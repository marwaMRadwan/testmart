...
import 'package:martizoom/presentation_layer/screens/categories/categories_phone_screen.dart';
import 'package:martizoom/shared/constants/constants.dart';

class MarketPhoneWidget extends StatelessWidget {
  final MarketModel topMarketModel;

  const MarketPhoneWidget({Key? key, required this.topMarketModel})
      : super(key: key);
